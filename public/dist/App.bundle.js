...
var mapOptions = {
  center: { lat: 45, lng: 41 },
  zoom: 8
};

function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 45;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 42;
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
      ...
      searchResults.innerHTML = _dompurify2.default.sanitize('<div class="search__result">\u041F\u043E \u0437\u0430\u043F\u0440\u043E\u0441\u0443 ' + _this.value + ' \u043D\u0438\u0447\u0435\u0433\u043E \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u043E </div>');
    }).catch(function (err) {
      console.error(err);
    });
  });
